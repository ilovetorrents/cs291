...
function createDrinkingBird() {
	...
	var hatMaterial = new THREE.MeshPhongMaterial( { shininess: 100, specular: new THREE.Color(0.5, 0.5, 0.5) } );
	hatMaterial.color.r = 24/255;
	hatMaterial.color.g = 38/255;
	hatMaterial.color.b = 77/255;

	var bodyMaterial = new THREE.MeshPhongMaterial( { shininess: 100, specular: new THREE.Color(0.5, 0.5, 0.5) } );
	bodyMaterial.color.setRGB( 31/255, 86/255, 169/255 );

	var legMaterial = new THREE.MeshPhongMaterial( { shininess: 4, specular: new THREE.Color(0.5, 0.5, 0.5) } );
	legMaterial.color.setHex( 0xAdA79b );

	var footMaterial = new THREE.MeshPhongMaterial( { shininess: 30, specular: new THREE.Color(0.5, 0.5, 0.5) } );
	footMaterial.color.setHex( 0x960f0b );
