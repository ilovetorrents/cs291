...
2. From the repository root run `npm install` to download the JavaScript dependencies. This pulls `three@0.56.0`, matching the legacy build the lessons were written against.
